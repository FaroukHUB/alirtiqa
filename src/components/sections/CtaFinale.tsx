      ...
      <div className="container-prose relative py-14 sm:py-20">
        ...
        >
          ...
          <p className="mt-5 max-w-xl text-balance text-creme/75">
            ...
            WhatsApp pour poser toutes vos questions.
          </p>
          ...
          <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-dore/40 px-6 py-3 font-medium tracking-wide text-creme transition-colors duration-300 hover:bg-dore/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-dore"
            >
